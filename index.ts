import { NotionRepository } from './src/infra/NotionAPI/Repositories/NotionRepository';
import { NotionService } from './src/AppService/Notion/NotionService';
...
async function main() {
  ...
  //       type: "function",
  //       function: {
  //         function: notionService.SearchPage,
  ...
  //       type: "function",
  //       function: {
  //         function: notionService.CreatePage,
