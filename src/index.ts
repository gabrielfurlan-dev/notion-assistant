      ...
      messages: [
        {
          role: "user",
          content:
            "Crie uma página dentro do caderno de viagens, dê o nome de Sampa.",
        },
        {
          role: "system",
            ...
            parameters: {
              ...
              properties: {
                input: {
                  type: "string",
                  description:
                    "parent pages name, child pages name or database name",
                },
              },
            },
          },
            ...
            parameters: {
              ...
              properties: {
                page: {
                  type: "object",
                  description:
                    "Page JSON properties as type of notion page documentation",
                },
              },
            },
          },
